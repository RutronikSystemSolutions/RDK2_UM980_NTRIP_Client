...
#define CY_CFG_SYSCLK_CLKALTSYSTICK_SOURCE CY_SYSTICK_CLOCK_SOURCE_CLK_ECO
#define CY_CFG_SYSCLK_CLKALTSYSTICK_INTERVAL 0
#define CY_CFG_SYSCLK_CLKALTSYSTICK_FREQUENCY 24000000
#define CY_CFG_SYSCLK_CLKALTSYSTICK_TICKS ((0)/1000000.0)*24000000
...
#define CY_CFG_SYSCLK_FLL_REFDIV 60U
...
#define CY_CFG_SYSCLK_FLL_SETTLING_COUNT 24U
...
#define CY_CFG_SYSCLK_PLL0_REFERENCE_DIV 3
